...
public class DetoxTest {
    ...
    @Rule
    public ActivityScenarioRule<MainActivity> mActivityRule = new ActivityScenarioRule<MainActivity>(MainActivity.class, false, false);
...
//        detoxConfig.rnContextLoadTimeoutSec = (com.rndemo.BuildConfig.DEBUG ? 180 : 60);
